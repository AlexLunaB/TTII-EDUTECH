<template>
    <div class="comments">
        ...
        <div class="reply">
            ...
            />
            <button class="reply--button" @click.prevent="submitComment"><i class="fa fa-paper-plane"></i>Enviar</button>
        </div>
    </div>
</template>
...
import singleComment from './SingleComment'
    export default {
        ...
        methods: {
            ...
            show() {
                console.log('perfil desde comments',this.perfil)
            }
        },
        mounted() {
            this.show()
        },
        props: ['comments', 'current_user', 'comments_wrapper_classes', 'perfil']
    }
</script>
